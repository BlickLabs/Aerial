...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Galería Dron Phantom 2</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Galería Drone Phantom 2</a></li>
			</ul>
                        <?php
                            include "config.php";
                            error_reporting(E_ALL);
                            $id_drone=1;
                            $res = $mysqli->query("SELECT id_drone,name_drone FROM drones where id_drone=$id_drone");
                            $mysqli->close();
