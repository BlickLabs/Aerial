      ...
      <div id="content" class="span10">
        ...
        <div class="row-fluid">
          ...
          <table id="example" class="display table table-bordered table-stripe" cellspacing="4"  style="margin-top: 50px">
            ...
            <tbody>
              <?php
                $res = $mysqli2->query("SELECT * FROM Images order by id desc");
                $mysqli2->close();
                while ($row = $res->fetch_assoc()):
                ?>
              <tr>
                <td style="text-align: center;" width="2%" class="mar-toptable"><?php echo $row['id'] ?></td>
                <td style="text-align: center;"width="8%"><?php echo $row['title'];  ?></td>
                <td width="10%"><img class="grayscale center-block" src="<?php echo 'php/album/' . $row['file'];?>" style="width: 250px;"></td>
              </tr>
              <?php
                endwhile;
                ?>
