        ...
        <div class="row-fluid sortable">
          <div class="box span12">
            <div class="box-header" data-original-title>
              <h2><i class="halflings-icon white picture"></i><span class="break">&nbsp;<?php echo $row['category'];?></span></h2>
              <div class="box-icon">
            ...
            <div class="box-content">
              <div class="masonry-gallery">
                <?php
                  include "config.php";
                  error_reporting(E_ALL);
                  $res2 = $mysqli2->query("SELECT * FROM Images WHERE category='$category'");
                   $mysqli2->close();
                   while ($row2 = $res2->fetch_assoc()){
                       $path= 'php/album/' . $row2['file'];
                  ?>
                <div class="masonry-thumb view view-first">
                  <img class="example-image" src="<?php echo $path= 'php/album/' . $row2['file'];?>" />
                  <div class="mask">
                    ...
                    <a button type="button" href="<?php echo $path= 'php/album/' . $row2['file'];?>" class="example-image-link btn btn-primary"  data-lightbox="example-set" ><i class="icon-zoom-in"></i> Zoom</a>
