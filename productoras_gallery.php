...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Galería Categorías Productoras</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Galería Productoras</a></li>
			</ul>
                        <?php
                            include "config.php";
                            error_reporting(E_ALL);
                            
                            $res = $mysqli->query("SELECT id_category,name_category FROM categorys where id_category='1'");
                            $mysqli->close();
